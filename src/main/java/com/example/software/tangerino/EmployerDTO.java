...
public class EmployerDTO {
     ...
     * @param email
     */
    public EmployerDTO(String companyName, String currentlyPerformsPunch, String email, String employeeRange, long id, String message, String origin, String password, String phone, String platform, boolean receiveNews, String sponsorName, String token) {
        super();
